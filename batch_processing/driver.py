...
@click.option( '--model', default="deepspeech-0.7.3-models.pbmm", type=click.FileName(exists=True, resolve_path=True))
@click.option( '--scorer', default="deepspeech-0.7.3-models.scorer", type=click.FileName(exists=True, resolve_path=True))
