...
## Examples
Real time streaming inference with Mozilla Voice STT's example audio ([audio-0.4.1.tar.gz](https://github.com/mozilla/STT/releases/download/v0.4.1/audio-0.4.1.tar.gz)).
```bash
